package {
	...
	public class Game extends MovieClip {
		...
		private function updateThings(): void {
			...
			// DONE: iterate through the array, updating each CoolThing
			// DONE: if a CoolThing object is "dead" remove it from the array
		...
		private function spawn(): void {
			...
			if (counter >= 10) {
				...
				// DONE: add the CoolThing object to the array
				coolThings.push(ct);
				addChild(ct);
				counter = 0;
			}
